...
const Product = ({ productData }) => {
    return (
        <div className='border mt-6 shadow-xl rounded-3xl w-auto hover:scale-[1.06] duration-500'>
            <img src={productData.img} alt={productData.img} className='rounded-t-3xl hover:opacity-80' />
            <div className='desktop:mx-8 laptop:mx-6 tablet:mx-4 phone:mx-2 mt-4 mb-8'>
