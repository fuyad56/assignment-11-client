    ...
    return (
        <div className='border mt-6 shadow-xl rounded-3xl w-auto hover:scale-[1.06] duration-500'>
            ...
            <div className='mx-6 mt-4 mb-8'>
                ...
                <Link to={"/products"} className='border-2 border-[#183D3D] text-lg tablet:text-md phone:text-md font-semibold text-slate-800 py-1 px-4 rounded hover:rounded-full hover:bg-[#183D3D] hover:text-slate-200'>See More</Link>
            </div>
        </div>
    );
};
