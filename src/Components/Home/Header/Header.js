...
const Header = () => {
    return (
        <main className='desktop:mt-[100px] laptop:mt-[120px] phone:mt-[60px] tablet:mt-0 mx-[200px] desktop:mx-[180px] laptop:mx-[120px] tablet:mx-[80px] phone:mx-[30px] mb-10'>
            <div className='desktop:flex laptop:flex justify-between items-center tablet:grid tablet:grid-rows-2 phone:grid phone:grid-rows-2'>
                ...
                <div className='tablet:mt-[-47px] desktop:m-0'>
                    <img src={Fan} alt="" className='desktop:w-[600px] tablet:w-[450px] phone:w-[261px] rounded-3xl shadow-xl' />
                </div>
            </div>
        </main>
    );
