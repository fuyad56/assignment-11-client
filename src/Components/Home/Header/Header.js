...
const Header = () => {
    return (
        <main className='desktop:mt-[100px] laptop:mt-[80px] phone:mt-[60px] tablet:mt-[-70px] mx-[200px] desktop:mx-[180px] laptop:mx-[120px] tablet:mx-[80px] phone:mx-[30px]'>
            <div className='desktop:flex laptop:flex justify-between items-center tablet:grid phone:grid grid-rows-2'>
                ...
                <div className='tablet:mb-10 tablet:mt-[-47px] desktop:m-0'>
